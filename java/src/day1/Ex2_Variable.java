...
public class Ex2_Variable {
	...
	public static void main(String[] args) {
		...
		/*1. 변수 선언 방법
		 * 타입 변수명;
		 * 2. 변수 초기화 방법1(변수 선언 및 초기화 : 선언과 초기화를 같이하는 방법)
		 * 타입 변수명 = 초기값;
		...
		long num4 = 10L; //십진수 10을 저장, long 자료형은 뒤에 L이나 l붙여야함
		...
		//int int;// 에약어(키워드)사용하여 에러 발생
		int $num7;
		$num7 = 7;
		
	 //int &num8;//_또는 $가 아니기 때문에 에러 발생
