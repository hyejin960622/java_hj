...
public class Ex1_Inherihancel1 {
...
class Child extends Parent{
	...
	public void print() {
		...
		System.out.println(getZ());//z에 직접적으로 접근할수 없기 때문에 getter를 이용하여 접근
		System.out.println(s);
	}
	public Child() {
		this(0,0,0,0);
		//super(0,0,0);//this()생성자와 super()생성자는 같이 쓸 수 없다. => this()에서 부모생성자를 이미 호출했기 때문에 
	}
