...
public class AccountBookManager implements ConsoleProgram{
	...
	public void excute(int menu) {
		...
		case 4 :
			...
			if(delItem != null) {
				...
				System.out.println("위 항목이 삭제 되었씁니다.");
				System.out.println("==========================");
			}else {
	...
	public boolean modifyAccountBook() {
		...
		System.out.println("==========================");
		System.out.print("선택한 항목내역은 위 내역입니다. 수정하시겠습니까? [예:true/아니요:false] : ");
		...
		System.out.println("날짜를 수정하겠습니까?[예:true/아니요:false] : ");
		ok = scan.nextBoolean();
		String date2 = null;
		if(ok) {
			System.out.print("날짜 : ");
		...
		System.out.println("결제방식을 수정하겠습니까?[예:true/아니요:false] : ");
		ok = scan.nextBoolean();
		...
		System.out.println("항목을 수정하겠습니까?[예:true/아니요:false] : ");
		ok = scan.nextBoolean();
		...
		System.out.println("금액을 수정하겠습니까?[예:true/아니요:false] : ");
		ok = scan.nextBoolean();
		int price2 = -1;
		if(ok) {
			System.out.print("금액 : ");
	...
	public Item deleteAccountBook() {
		...
		return abook.deletItem(delIndex-1);
	}
