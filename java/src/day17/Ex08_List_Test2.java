...
public class Ex08_List_Test2 {
	...
	public static void main(String[] args) {
		...
		list.add(std);
		/* - Student 클래스에 equals를 오버라이딩 하지 않으면 indexOf, contains, remove 메소드가 원하는대로 동작하지 않음.*/
		...
		System.out.println("list에서 학생 정보를 삭제했습니까?  " + list.remove(new Student(1, 1, 1, "홍길동")));
...
class Student{
	...
	public Student(Student std) {
		...
		this.name = new String(std.name); //깊은복사 
	}
