...
public class Ex07_Lambda_Function {
	...
	public static void main(String[] args) {
		...
		list.add(new Student(1, 1, 3, 20, 50, 80, "둘리"));
		list.add(new Student(1, 1, 4, 10, 60, 30, "고길동"));
		...
		System.out.println("국어 총점 : " + sum(list, "국어", f));
		System.out.println("영어 총점 : " + sum(list, "영어", f));
		System.out.println("수학 총점 : " + sum(list, "수학", f));
