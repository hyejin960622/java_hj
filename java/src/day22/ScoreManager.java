...
public class ScoreManager implements ConsoleProgram{
	...
	private boolean modifyScore() {
		...
		/*
		//이 코드는 중간에 잘못 입력하면 잘못 입력되기전까지의 정보만 수정됨
		...
		*/
		...
		list.remove(tmp);//기존에 있던 학생정보를 삭제
	...
	public void run() {
		//샘플데이터
		list.add(new score(1,1,"국어",100,98,65));
		list.add(new score(1,2,"수학",89,94,85));
		list.add(new score(1,1,"영어",80,98,75));
