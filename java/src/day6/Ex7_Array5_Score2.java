...
public class Ex7_Array5_Score2 {
	...
	public static void main(String[] args) {
		...
		//입력받은 학생수가 10보다 크면 최대 10명까지입니다. 라고 출력
			if(count > 10) {
				System.out.println("최대10명까지 입니다.");
			}
			
		//입력받은 학생수가 10보다 크지 않고 0보다 작거나 같으면 최소 1명부터입니다.
			else if(count <= 0) {
				System.out.println("최소1명부터입니다.");
			}
		//입력받은 학생수가 10보다 크지않고 0보다 작거나 같지 않으면 입력받은 학생수만큼 성적 입력후 총점계산
			else {
				int sum = 0;
				double avg = 0.0;
