...
public class Ex2_Method2_Lotto {
	 ...
	 * 매개변수 : 스캐너, 입력받을 정수의 갯수 = > Scanner scan. int n
	 * 리턴타입 : 정수 배열 = > int []
	 * 메소드명 : intputCreateArray
	 * */
	 ...
	 * 매개변수 : 최소값, 최댓값 , 개수 => int min, int max, int n
	 * 리턴타입 : 중복되지않은 수르 ㄹ저장한 배열 => int []
	 ...
	 * 매개변수 : 일치하는 갯수 , 보너스 일치 여부 = > int count, boolean bonusOk
	 * 리턴타입 : 없음 = > void
	 * 매소드명 : printResult
	 * 
	 * */
